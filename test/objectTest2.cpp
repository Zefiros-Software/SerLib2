...
SERIALISATION_TEST2( NonExisting, ObjectVector, SinglePrimitive< uint8_t >, SkippedObjectVector< type >, type, 414242 * ( std::is_same< type, std::string >::value ? 32 : sizeof( type ) ), 414242 );
